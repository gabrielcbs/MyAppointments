...
{
	public class ListAppointmentsViewModel : BaseViewModel, IListAppointmentsViewModel
	{
		...
		public MvxCommand ReloadDataCommand
		{
			get
			{
				...
				{
					Appointments = (await _appointmentDataService.GetAppointments()).ToObservableCollection();
				});
			}
		}

		public ListAppointmentsViewModel(IMvxMessenger messenger, IAppointmentDataService appointmentDataService) 
			: base(messenger)
		{
